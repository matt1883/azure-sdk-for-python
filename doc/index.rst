...
You can also install individually each library for each Azure service:
...
You can also install the whole set of stable Azure libraries in a single line using the ``azure`` meta-package:
